<template>
  <scroll class="listview" @scroll="scroll" :listen-scroll="listenScroll" :probe-type="probeType" :data="data" ref="listview">
    <ul>
      <li ref="listGroup" class="list-group" v-for="(group, index) in data" :key="index">
        <h2 class="list-group-title">{{group.title}}</h2>
        <ul>
          <li @click="selectItem(item)" v-for="item in group.items" :key="item.singer_id" class="list-group-item">
